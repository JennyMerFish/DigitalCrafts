...
function fetchPokemonData() {
    ...
    for (pokes of pokemonData){
        
        const cards = document.createElement("div");
        cards.className = "cards";
        const cardImg = document.createElement("img");
        cardImg.className = "images";
...
// for (pokes of data) {
//     images.src = data[0].pokemon[0].sprites.front       
// }
// // console.log(data[0].pokemon[0].sprites.front)
// // console.log(data[0].pokemon[0])
